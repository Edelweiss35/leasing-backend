...
def main(filename, clauses):
    ...
    for clause in clauses:
        while True:
            try:
                clause_text = ""
                clause['clause_name'] = clean(clause['clause_name'])
                ...
                clause_regex2 = "(([0-9]{,9}\.+[0-9]{,9}\.+[0-9]+|[0-9]{,9}\.+[0-9]{,9}\.+|[0-9]{,9}\.+) (%s +|%s\. +|%s\: +|%s\; +|%s\ . +|%s\ : +|%s\ ; +)(\(|[a-z]|[A-Z])(.|\n)+?)([0-9]+\.[0-9]+\.[0-9]|[0-9]+\.|[0-9]+\.[0-9]+) [A-Z]" % (clause_name, clause_name, clause_name,clause_name, clause_name, clause_name, clause_name)
                clause_regex21 = "(([0-9]+\.[0-9]+\.[0-9]+|[0-9]+\.[0-9]\.+|[0-9]+\.) (%s +|%s\. +|%s\: +|%s\; +|%s\ . +|%s\ : +|%s\ ; +)(\(|[a-z]|[A-Z])(.|\n)+?([0-9]+\.|[0-9]+\.[0-9]+) [A-Z]{2})" % (clause_name, clause_name, clause_name,clause_name, clause_name, clause_name, clause_name)
